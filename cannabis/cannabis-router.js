...
router.post('/prediction', (req, res) => {
    ...
    axios.post(`https://unburied-medcab.herokuapp.com/prediction?disease=${info[0]}pain&effect1=${info[4]}&effect2=${info[5]}&effect3=${info[6]}&effect4=${info[7]}&effect5=${info[8]}&flavor1=${info[1]}&flavor2=${info[2]}&flavor3=${info[3]}`)
        .then(res => {
